 ...
 * LAYERED DEPTH: OUTER AMBIENT BLOOM -> MID GLASS SHELL -> CORE LIGHT -> ORBITING PARTICLES.
 * `STATE` DRIVES BREATHING/PULSE TEMPO AND INTENSITY.
 *
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ rotate: -360 }}
        transition={{
          duration: config.particleSpeed * 1.8,
          repeat: Infinity,
          ease: "linear",
        }}
      >
