...
export function StarBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden bg-nebula-bg" aria-hidden="true">
      {/* Ambient nebula glow */}
      <div
        ref={glowLayerRef}
      ...
      {/* Far, dim star layer — barely moves, reads as depth */}
      ...
      {/* Near, brighter star layer — subtle twinkle + parallax */}
      ...
      {/* Ambient drifting particles — soft, slow, sparse */}
